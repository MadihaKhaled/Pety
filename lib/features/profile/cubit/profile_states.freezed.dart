...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'ProfileStates<$T>.error(error: $error)';
  }
...
class __$$GeneralDataLoadingImplCopyWithImpl<T, $Res>
    extends _$ProfileStatesCopyWithImpl<T, $Res, _$GeneralDataLoadingImpl<T>>
...
class _$GeneralDataLoadingImpl<T> implements GeneralDataLoading<T> {
  ...
  @override
  String toString() {
    return 'ProfileStates<$T>.loadGeneralData()';
  }
...
abstract class GeneralDataLoading<T> implements ProfileStates<T> {
...
class __$$GeneralDataSuccessImplCopyWithImpl<T, $Res>
    extends _$ProfileStatesCopyWithImpl<T, $Res, _$GeneralDataSuccessImpl<T>>
...
class _$GeneralDataSuccessImpl<T> implements GeneralDataSuccess<T> {
  ...
  @override
  String toString() {
    return 'ProfileStates<$T>.successGeneralData()';
  }
